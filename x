...
if getgenv().Configuration.IntroSettings.ShowIntro then
    ...
    sound.Volume = 5  -- Start with a lower volume
    ...
    for volume = 5, 0, -0.1 do  -- Decrease volume from 5 to 0 in smaller increments
        sound.Volume = volume
        wait(0.2)  -- Adjust the speed of the volume decrease as needed
    end
